...
class AddWorkspaceImage201Response(BaseModel):
    """
    AddWorkspaceImage201Response
    """ # noqa: E501
    status: Optional[BasicAPIReply] = None
    data: Optional[WorkspaceImage] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "data": WorkspaceImage.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
